...
<% 
	...
	int tot = 0;
	 ...
	 if(request.getAttribute("goods_num") != null){
		 
		 goods_num = (Integer)request.getAttribute("goods_num");
				...
				if(user_grade == 3){
					...
					$.ajax({
						...
						success : function(data) {
							...
							location.href = "review.credu?goods_num=<%=goods_num%>";
...
<body>
	...
	<div class="container">
		...
		<h4 class="info-box-heading green">Customer Reviews</h4>
		...
		<table class="table">
			...
			<tbody>
				...
				<tr class="info">
					...
					<td><a data-toggle="modal" data-target="#myModal2" onclick="review_read(${review_Bean.review_num}, '${review_Bean.user_id}')">${review_Bean.review_title}</a></td>
  	...
  	<div class="modal fade" id="myModal" role="dialog">
        ...
        <div class="modal-body">
			...
			<div class="panel panel-success" style="margin-top: 10px;">
				...
				<div class="panel-body">
					<%-- form --%>
					<form class="form-horizontal" role="form" action="${review_write}?goods_num=<%=goods_num%>" method="post" id="input">
						<div class="form-group">
							<label class="control-label col-sm-2">ID:</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="user_id"
									name="user_id" placeholder="ID" readonly="readonly" value="${sessionScope.login.user_id}">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="review_title"
									name="review_title" placeholder="Title" autofocus="autofocus" required="required">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="review_goods_name"
									name="review_goods_name" placeholder="상품명" required="required">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2" for="pwd">내용:</label>
							<div class="col-sm-10">
								<textarea class="form-control" rows="5"	placeholder="review_content" name="review_content" id="review_content" required="required"></textarea>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<div class="radio">
									...
									<label class="radio-inline" style="font-size: 6px;"> <input type="radio" name="review_star" id="review_star" value="1" checked="checked">★☆☆☆☆</label>
									<label class="radio-inline" style="font-size: 6px;"> <input type="radio" name="review_star" id="review_star" value="2">★★☆☆☆</label>
									<label class="radio-inline" style="font-size: 6px;"> <input type="radio" name="review_star" id="review_star" value="3">★★★☆☆</label>
									<label class="radio-inline" style="font-size: 6px;"> <input type="radio" name="review_star" id="review_star" value="4">★★★★☆</label>
									<label class="radio-inline" style="font-size: 6px;"> <input type="radio" name="review_star" id="review_star" value="5">★★★★★</label>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-info" data-dismiss="modal" onclick="reset()">Close</button>
        </div>
      </div>
