...
/**
 * Servlet implementation class odermangeServlet
 */
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			ArrayList<odermangebean> list
				= OrderMangeDAO.get_oder_mange_all(page_num);
			
			// 페이지의 개수를 가져온다.
			
			int cnt =  OrderMangeDAO.get_page_cnt();
						// request에 담는다.
			request.setAttribute("list", list);
			request.setAttribute("cnt", cnt);
			// board_main.jsp로 이동한다.
			String site = "admin/order_main_mange.jsp";
