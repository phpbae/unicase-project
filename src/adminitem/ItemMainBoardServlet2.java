 ...
 */
@WebServlet("/ItemMainBoardServlet2")
public class ItemMainBoardServlet2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ItemMainBoardServlet2() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			ArrayList<ItemBean> list
				= ItemDAO.get_board_all2(page_num);
			...
			String site = "admin/item/item_mange_index2.jsp";
